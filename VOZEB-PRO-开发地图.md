...
> 基线：2026-08-27，`main` 分支。当前源码包含 48 个 `page.tsx` 页面入口、282 个 API Route 文件和 108 张 PostgreSQL 表。接口逐项说明见 [VOZEB-PRO 接口索引](VOZEB-PRO-接口索引.md)，发布操作见 [VOZEB-PRO 更新与部署流程](VOZEB-PRO-更新部署流程.md)。

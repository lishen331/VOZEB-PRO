...
> 生成日期：2026-09-15。枚举来源仅为 `web/src/app/api/**/route.ts`；当前共 **372** 个 Route 文件。每个文件一行，多种 HTTP 方法合并显示。
...
- Route 文件：**372**
- 方法出现次数：DELETE 57、GET 198、HEAD 6、PATCH 57、POST 205、PUT 12
...
| PATCH | `/api/admin/practice-script/agents/[agentKey]` | 管理员 | [route.ts](web/src/app/api/admin/practice-script/agents/[agentKey]/route.ts) | [postgres](web/src/lib/server/database/postgres.ts)<br>[script-agent-domain](web/src/lib/server/script-agent-domain.ts)<br>[script-agent-skills](web/src/lib/server/script-agent-skills.ts) | PostgreSQL、管理配置、审计日志 | 管理后台 / practice-script / agents / [agentKey]：更新 |
...
| POST | `/api/drama-lab/projects/[id]/assets/[assetId]/ai` | 混合 | [route.ts](web/src/app/api/drama-lab/projects/[id]/assets/[assetId]/ai/route.ts) | [drama-lab-asset-ai-service](web/src/lib/server/drama-lab-asset-ai-service.ts)<br>[drama-lab-collaboration-service](web/src/lib/server/drama-lab-collaboration-service.ts)<br>[drama-lab-collaboration-error](web/src/lib/server/drama-lab-collaboration-error.ts) | PostgreSQL | drama-lab / 项目 / 单项 / 资产 / 指定媒体 / 模型代理：提交/执行 |
...
| POST | `/api/drama-lab/projects/[id]/episodes/[episodeId]/render` | 混合 | [route.ts](web/src/app/api/drama-lab/projects/[id]/episodes/[episodeId]/render/route.ts) | [drama-lab-final-video-service](web/src/lib/server/drama-lab-final-video-service.ts) | PostgreSQL | drama-lab / 项目 / 单项 / episodes / [episodeId] / 渲染：提交/执行 |
| GET | `/api/drama-lab/projects/[id]/episodes/[episodeId]/render/artifact/[artifactId]` | 混合 | [route.ts](web/src/app/api/drama-lab/projects/[id]/episodes/[episodeId]/render/artifact/[artifactId]/route.ts) | [drama-lab-final-video-service](web/src/lib/server/drama-lab-final-video-service.ts)<br>[reference-asset-store](web/src/lib/server/reference-asset-store.ts) | PostgreSQL | drama-lab / 项目 / 单项 / episodes / [episodeId] / 渲染 / artifact / [artifactId]：查询 |
...
| POST | `/api/drama-lab/projects/[id]/import-novel` | 用户 | [route.ts](web/src/app/api/drama-lab/projects/[id]/import-novel/route.ts) | [drama-lab-collaboration-service](web/src/lib/server/drama-lab-collaboration-service.ts)<br>[drama-lab-novel-import-service](web/src/lib/server/drama-lab-novel-import-service.ts)<br>[drama-lab-novel-file-parser](web/src/lib/server/drama-lab-novel-file-parser.ts) | PostgreSQL | drama-lab / 项目 / 单项 / import-novel：提交/执行 |
...
| DELETE, GET, POST | `/api/drama-lab/story-options` | 用户 | [route.ts](web/src/app/api/drama-lab/story-options/route.ts) | [drama-lab-story-options-service](web/src/lib/server/drama-lab-story-options-service.ts) | PostgreSQL | drama-lab / story-options：查询、删除、提交/执行 |
...
| POST | `/api/practice/prompt-optimization` | 混合 | [route.ts](web/src/app/api/practice/prompt-optimization/route.ts) | [practice-access-service](web/src/lib/server/practice-access-service.ts)<br>[prompt-optimization-service](web/src/lib/server/prompt-optimization-service.ts)<br>[store](web/src/lib/auth/store.ts) | PostgreSQL | practice / 提示词优化：提交/执行 |
| GET, POST | `/api/practice/scripts` | 混合 | [route.ts](web/src/app/api/practice/scripts/route.ts) | [practice-access-service](web/src/lib/server/practice-access-service.ts)<br>[script-practice-service](web/src/lib/server/script-practice-service.ts)<br>[script-agent-domain](web/src/lib/server/script-agent-domain.ts) | PostgreSQL | practice / scripts：查询、提交/执行 |
...
| PATCH | `/api/practice/scripts/[id]/chat-sessions/[sessionId]` | 混合 | [route.ts](web/src/app/api/practice/scripts/[id]/chat-sessions/[sessionId]/route.ts) | [postgres](web/src/lib/server/database/postgres.ts)<br>[script-agent-repository](web/src/lib/server/database/script-agent-repository.ts)<br>[practice-tenant-scope](web/src/lib/server/practice-tenant-scope.ts) | PostgreSQL | practice / scripts / 单项 / chat-sessions / [sessionId]：更新 |
| GET, POST | `/api/practice/scripts/[id]/chat-sessions/[sessionId]/messages` | 混合 | [route.ts](web/src/app/api/practice/scripts/[id]/chat-sessions/[sessionId]/messages/route.ts) | [script-agent-confirmation-service](web/src/lib/server/script-agent-confirmation-service.ts)<br>[script-agent-run-service](web/src/lib/server/script-agent-run-service.ts)<br>[postgres](web/src/lib/server/database/postgres.ts) | PostgreSQL | practice / scripts / 单项 / chat-sessions / [sessionId] / 消息：查询、提交/执行 |
| POST | `/api/practice/scripts/[id]/confirmations` | 混合 | [route.ts](web/src/app/api/practice/scripts/[id]/confirmations/route.ts) | [script-agent-confirmation-service](web/src/lib/server/script-agent-confirmation-service.ts)<br>[script-agent-repository](web/src/lib/server/database/script-agent-repository.ts)<br>[practice-tenant-scope](web/src/lib/server/practice-tenant-scope.ts) | PostgreSQL | practice / scripts / 单项 / confirmations：提交/执行 |
| GET | `/api/practice/scripts/[id]/export` | 混合 | [route.ts](web/src/app/api/practice/scripts/[id]/export/route.ts) | [practice-access-service](web/src/lib/server/practice-access-service.ts)<br>[script-practice-service](web/src/lib/server/script-practice-service.ts)<br>[postgres](web/src/lib/server/database/postgres.ts) | PostgreSQL | practice / scripts / 单项 / 导出：查询 |
...
| DELETE, GET, POST | `/api/practice/sessions/[id]` | 混合 | [route.ts](web/src/app/api/practice/sessions/[id]/route.ts) | [practice-session-service](web/src/lib/server/practice-session-service.ts)<br>[generation-execution-policy](web/src/lib/server/generation-execution-policy.ts)<br>[practice-reference-authorization](web/src/lib/server/practice-reference-authorization.ts) | PostgreSQL | practice / sessions / 单项：查询、删除、提交/执行 |

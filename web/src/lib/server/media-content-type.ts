...
export async function resolveMediaMimeType(bytes: Buffer, type: "image" | "video" | "audio", declaredMime?: string | null) {
    ...
    if (!normalizedDeclaredMime) return type === "video" ? "video/mp4" : type === "audio" ? "audio/mpeg" : "image/png";

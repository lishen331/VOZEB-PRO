...
const POSTGRES_SCHEMA_OBJECTS = [
    ...
    "rbac_user_role_bindings_pkey",
    "rbac_user_role_bindings_scope_unique_idx",
    "rbac_user_role_bindings_platform_user_unique_idx",
    "rbac_user_role_bindings_role_idx",

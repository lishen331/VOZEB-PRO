...
const POSTGRES_SCHEMA_OBJECTS = [
    ...
    "ip_content_files_ip_id_unique",
    "ip_content_files_ip_status_created_idx",
    ...
    "ip_items_file_idx",
    "ip_school_grants_ip_school_created_idx",
    "ip_school_grants_school_status_window_idx",
    "ip_school_grants_exclusive_active_idx",
    "ip_school_grants_member_access_user_fk",
    "ip_usage_records_ip_created_idx",
    "ip_usage_records_school_created_idx",
    "ip_usage_records_user_created_idx",
    "ip_download_records_version_ip_fk",
    ...
    "ip_items_immutable",
    "ip_library_prevent_published_file_mutation",
    "ip_content_files_immutable",

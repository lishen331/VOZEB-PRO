...
export const FEATURE_MODULES: readonly FeatureModuleDefinition[] = [
    ...
    { id: "drama-lab", name: "短剧实验室", description: "独立短剧生产工作流", group: "projects", icon: FlaskConical, pathPrefixes: ["/drama-lab"], routeRoot: "drama-lab" },
    { id: "practice", name: "无限练习", description: "学校场景下的创作练习", group: "projects", icon: Sparkles, pathPrefixes: ["/practice"], routeRoot: "practice" },

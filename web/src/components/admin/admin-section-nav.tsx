...
export const adminSections: AdminSection[] = [
    ...
    { key: "dramaLab", label: "短剧实验室", description: "集中管理 LocalMiniDrama 适配流程所需的模型、提示词和能力接入。", shortDescription: "独立短剧配置", icon: <Clapperboard className="size-4" /> },
...
export const adminSectionGroups: AdminSectionGroup[] = [
    ...
    { title: "上游配置", items: sectionsFor(["dramaLab", "channels", "skills"]) },

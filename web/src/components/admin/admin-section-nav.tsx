...
export const adminSections: AdminSection[] = [
    ...
    { key: "roleManagement", label: "角色管理", description: "创建和维护角色及其菜单权限。", shortDescription: "角色权限", icon: <UsersRound className="size-4" /> },
    { key: "administratorManagement", label: "管理员管理", description: "创建和维护平台管理员账号与角色。", shortDescription: "管理员账号", icon: <UsersRound className="size-4" /> },
...
export const adminSectionGroups: AdminSectionGroup[] = [
    { title: "经营分析", items: sectionsFor(["overview", "users", "logs", "generationOperations", "dramaProjects"]) },
    ...
    { title: "上游配置", items: sectionsFor(["channels", "practice", "skills", "plugins"]) },
    { title: "创作工坊配置", items: sectionsFor(["dramaLabConfig", "dramaLabPrompts", "dramaLabScenarios", "dramaLabGeneration", "dramaLabSd2"]) },
    { title: "权限管理", items: sectionsFor(["roleManagement", "administratorManagement"]) },

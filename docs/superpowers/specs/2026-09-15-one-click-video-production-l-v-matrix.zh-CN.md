...
| **必须迁移的业务逻辑** | **108** | **已覆盖 99，即 91.7%**（§13–§18 逐条核算） |

**结论（2026-09-17 更新）：主链路已覆盖 99/108（91.7%），分镜与资产链路具备真机验证条件；仍有 5 条 P2 缺口与 4 条刻意不复制项，不等于 1:1 完成。**
...
**合计：覆盖 99/108，刻意不复制 4，仍为缺口 5（全部 P2）。**
